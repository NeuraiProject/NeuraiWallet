...
export async function isDisabled(): Promise<boolean> {
  // BlueElectrum is dead code for NeuraiWallet — we don't ship a Bitcoin
  // Electrum server, and connecting to electrum1.bluewallet.io et al. just
  // produces reconnect loops. Always report disabled so `connectMain`,
  // `waitTillConnected` and the rest of the gates short-circuit.
  return true;
}
