  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={[nStyles.button, { backgroundColor: colors.newBlue }]}>
          <Text style={[nStyles.buttonText, { color: colors.buttonTextColor }]}>{loc.wallets.list_create_a_button}</Text>
        </View>
      </Animated.View>
    </Pressable>
  );
