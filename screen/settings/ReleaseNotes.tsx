...
const NEURAI_ADAPTATION_NOTES: string[] = [
  ...
  'JSON-RPC backend (@neuraiproject/neurai-rpc) for balance, history, UTXO scan, fee estimation and broadcast. ElectrumX backend stub in place for future deployment.',
  ...
  'Receive screen polls the RPC backend every 5 seconds for incoming payments and switches to a success view as soon as funds land.',
